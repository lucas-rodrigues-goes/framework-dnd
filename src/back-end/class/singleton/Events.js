...
var Events = class {
        ...
        static onChangeImpersonated () { try {
        ...
        } catch (error) {console.error("Events.onMouseOver()", error)} }

        static onMouseClick ({x, y}) { try {
            console.log(`x: ${x}, y: ${y}`,"all")
        } catch (error) {console.error("Events.onMouseClick()", error)} }

        static onMouseOff ({id}) { try {
            
        } catch (error) {console.error("Events.onMouseOff()", error)} }

        static onChangeSelection () { try {
                this.updateTarget()
        } catch (error) {console.error("Events.onChangeSelection()", error)} }

        static onTokenMove ({id}) { try {
            
        } catch (error) {console.error("Events.onTokenMove()", error)} }

        static onChangeMap({id}) { try {
        ...
        static runJSfunction = ({name, type="Overlay", functionName, args=[], targets, runOnAllClients=false }) => { try {
